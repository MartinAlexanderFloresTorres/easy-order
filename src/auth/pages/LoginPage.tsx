  ...
  return (
    ...
    >
      ...
      <div className="max-w-[450px] border border-zinc-800 w-full mx-auto bg-zinc-900 p-5 rounded-md flex flex-wrap items-center gap-6">
        <Link
          to="/auth/register"
          className="w-full text-center items-center gap-2 hover:bg-zinc-800 border border-zinc-800 transition-all duration-100 text-zinc-100 px-5 py-3 uppercase text-sm font-semibold"
        >
          Registrarse
        </Link>
      </div>
